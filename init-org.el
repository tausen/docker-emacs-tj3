...
taskreport plan \"\" {
  ...
  columns bsi, name, start, end, effort, complete, effortleft, resources, chart { width 2500 }
  loadunit shortauto
  hideresource 1
}
...
include \"tasks-bookings.tji\"")))  ;; <- assuming tasks-bookings.tji exists!
